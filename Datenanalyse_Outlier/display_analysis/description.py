OUTLIER_DESCRIPTIONS = {
    ...
    "Ressource_sehr_aktiv": {
        "title": "Ungewöhnlich aktive Ressource",
    ...
    "Ressource_wenig_aktiv": {
        "title": "Ungewöhnlich wenig aktive Ressource",
    ...
    "Ressource_vielfältige_Aktivitäten": {
        "title": "Ressource mit vielen verschiedenen Aktivitäten",
    ...
    "Zeitstempel_in_Zukunft": {
        "title": "Zeitstempel in der Zukunft",
    ...
    "Lange_Aktivitätsdauer": {
        "title": "Ungewöhnlich lange Aktivitätsdauer",
    ...
    "Kurze_Aktivitätsdauer": {
        "title": "Ungewöhnlich kurze Aktivitätsdauer",
    ...
    "Negative_Aktivitätsdauer": {
        "title": "Negative Aktivitätsdauer",
    ...
    "Lange_Traces": {
        "title": "Ungewöhnlich lange Traces",
    ...
    "Kurze_Traces": {
        "title": "Ungewöhnlich kurze Traces",
    ...
    "Traces_viele_Aktivitäten": {
        "title": "Traces mit vielen verschiedenen Aktivitäten",
    ...
    "Traces_wenig_Aktivitäten": {
        "title": "Traces mit wenigen verschiedenen Aktivitäten",
    ...
    "Ungewöhnliche_Tracesequenz": {
        "title": "Ungewöhnliche Aktivitätssequenz",
    ...
    "Fehlende_Aktivitäten_im_Trace": {
        "title": "Trace mit fehlenden Aktivitäten",
