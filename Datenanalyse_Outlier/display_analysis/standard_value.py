...
def show_standard_compare(log):
    """
    Zeigt eine Standardwert-Analyse für Prozess- und Aktivitätsdauer im Streamlit-Interface an.
    Args:
        log (pandas.DataFrame): Eventlog als Dataframe.
        standard_dict (dict, optional): Enthält verdefinierte Standardwerte für den Vergleich.
        source_col (str, optional): Name der Spalte im Eventlog, deren Werte mit Standardwerten verglichen werden sollen.

    Rückgabewert:
        Erzeugt UI-Elemente zur Anzeige von Standardwerten und Abweichungen.
    """
