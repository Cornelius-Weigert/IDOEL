...
def outlier_trace(log_df, case_col="case_id"):
    """
    Identifiziert Ausreißer auf Traces-Ebene innerhalb eines Eventlogs.
    ...
    Rückgabewert:
        dict: Dictionary mit Kategorien von Trace-Ausreißern und den jeweiligen Zeilenindizes im Eventlog.
    """
