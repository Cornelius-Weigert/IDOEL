...
def load_eventLog_from_csv(path, separator=',', case_id='Case ID', activity_key='Activity', timestamp_key='Complete Timestamp'):
...
def main():
    log = load_eventLog_from_csv('Eventlogs/eventlog.csv')
